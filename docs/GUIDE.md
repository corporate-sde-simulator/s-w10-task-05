...
> **Welcome to Service-Track Week 10, Task 5!**
...
| `src/migration.py` | Main source code - **has bugs to fix** |
| `src/schemaUtils.py` | Supporting code - **may also have bugs** |
| `tests/test_migration.py` | Test file - **add your tests here** |
